const i18n = {
  'en-US': {
    ...
    'login.form.userName.emptyErr': 'Username cannot be empty',
    'login.form.userName.unvalidErr': 'Username is not valid',
    'login.form.password.emptyErr': 'Password cannot be empty',
    'login.form.password.unvalidErr': 'Password is not valid',
  ...
  'zh-CN': {
    ...
    'login.form.userName.emptyErr': '用户名不能为空',
    'login.form.userName.unvalidErr': '用户名格式不规范',
    'login.form.password.emptyErr': '密码不能为空',
    'login.form.password.unvalidErr': '密码格式不规范',
